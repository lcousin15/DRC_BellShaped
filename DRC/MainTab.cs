...
namespace DRC
{
    ...
    public partial class MainTab : Form
    {
        ...
        private List<string> fixed_plateau1_descriptor;
        private List<string> fixed_plateau2_descriptor;
        private List<string> fixed_dip_descriptor;
        private List<string> fixed_ec50_1_descriptor;
        private List<string> fixed_ec50_2_descriptor;
        private List<string> fixed_slope1_descriptor;
        private List<string> fixed_slope2_descriptor;
        ...
        private void read_Data()
        {
            ...
            fixed_plateau1_descriptor = new List<string>();
            fixed_plateau2_descriptor = new List<string>();
            fixed_dip_descriptor = new List<string>();
            fixed_ec50_1_descriptor = new List<string>();
            fixed_ec50_2_descriptor = new List<string>();
            fixed_slope1_descriptor = new List<string>();
            fixed_slope2_descriptor = new List<string>();
            ...
            foreach (DataGridViewColumn col in f3.dataGridView1.Columns)
            {
                ...
                if (col_name.StartsWith("Fixed_Plateau1"))
                {
                    fixed_plateau1_descriptor.Add(col_name);
                }

                if (col_name.StartsWith("Fixed_Plateau2"))
                {
                    fixed_plateau2_descriptor.Add(col_name);
                }

                if (col_name.StartsWith("Fixed_Dip"))
                {
                    fixed_dip_descriptor.Add(col_name);
                }

                if (col_name.StartsWith("Fixed_Ec50_1"))
                {
                    fixed_ec50_1_descriptor.Add(col_name);
                }

                if (col_name.StartsWith("Fixed_Ec50_2"))
                {
                    fixed_ec50_2_descriptor.Add(col_name);
                }

                if (col_name.StartsWith("Fixed_Slope1"))
                {
                    fixed_slope1_descriptor.Add(col_name);
                }

                if (col_name.StartsWith("Fixed_Slope2"))
                {
                    fixed_slope2_descriptor.Add(col_name);
                }
        ...
        private void exportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (folderBrowserDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                f5.dataGridViewExport.ColumnCount = 2 + column_number * descriptor_list.Count;
                ...
                foreach (string elem in descriptor_list)
                {
                    ...
                    f5.dataGridViewExport.Columns.Insert(column_number * i + 2, img);
                ...
                for (var idx = 0; idx < list_cpd.Count; idx++)
                {
                    ...
                    foreach (Chart_DRC current_chart in list_chart)
                    {
                        ...
                        double current_ec_50_1 = fit_params[3];
                        double current_ec_50_2 = fit_params[4];
                        double current_bottom = fit_params[0];
                        double current_top = fit_params[1];
                        double current_dip = fit_params[2];
                        double current_slope1 = fit_params[5];
                        double current_slope2 = fit_params[6];


                        Image image = LoadImageNoLock(list_images[i_img]);

                        //f5.dataGridViewExport.Rows[index].Height = 
                        f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 2].Value = image;
                        if (!not_fitted || !inactive)
                        {
                            if (last_2_points_text == true)
                            {
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 3].Value = Math.Pow(10, current_ec_50_1).ToString("E2");
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 3].Style.BackColor = Color.Green;

                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 4].Value = Math.Pow(10, current_ec_50_2).ToString("E2");
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 4].Style.BackColor = Color.Green;

                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 5].Value = current_bottom.ToString("E2");
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 5].Style.BackColor = Color.Green;

                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 6].Value = current_top.ToString("E2");
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 6].Style.BackColor = Color.Green;

                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 7].Value = current_dip.ToString("E2");
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 7].Style.BackColor = Color.Green;

                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 8].Value = current_slope1.ToString("E2");
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 8].Style.BackColor = Color.Green;

                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 9].Value = current_slope2.ToString("E2");
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 9].Style.BackColor = Color.Green;
                            }
                            else
                            {
                                f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 3].Value = Math.Pow(10, current_ec_50_1).ToString("E2");
                        ...
                        if (not_fitted)
                        {
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 3].Value = "Not Fitted";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 3].Style.BackColor = Color.Tomato;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 4].Value = "Not Fitted";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 4].Style.BackColor = Color.Tomato;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 5].Value = "Not Fitted";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 5].Style.BackColor = Color.Tomato;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 6].Value = "Not Fitted";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 6].Style.BackColor = Color.Tomato;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 7].Value = "Not Fitted";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 7].Style.BackColor = Color.Tomato;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 8].Value = "Not Fitted";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 8].Style.BackColor = Color.Tomato;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 9].Value = "Not Fitted";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 9].Style.BackColor = Color.Tomato;
                        }
                        if (inactive)
                        {
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 3].Value = "Inactive";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 3].Style.BackColor = Color.Orange;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 4].Value = "Inactive";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 4].Style.BackColor = Color.Orange;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 5].Value = "Inactive";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 5].Style.BackColor = Color.Orange;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 6].Value = "Inactive";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 6].Style.BackColor = Color.Orange;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 7].Value = "Inactive";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 7].Style.BackColor = Color.Orange;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 8].Value = "Inactive";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 8].Style.BackColor = Color.Orange;

                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 9].Value = "Inactive";
                            f5.dataGridViewExport.Rows[index].Cells[i_img * column_number + 9].Style.BackColor = Color.Orange;
                        }
        ...
        private void draw_drc()
        {
            ...
            foreach (var item in checkedListBox1.CheckedItems)
            {
                ...
                f2.dataGridView2.Columns[j * output_parameter_number + 8].Name = "R2 " + item.ToString();
            ...
            for (var idx = 0; idx < list_cpd.Count; idx++)
            {
                ...
                Dictionary<string, string> fixed_plateau1_status = new Dictionary<string, string>();
                Dictionary<string, string> fixed_plateau2_status = new Dictionary<string, string>();
                Dictionary<string, string> fixed_dip_status = new Dictionary<string, string>();
                Dictionary<string, string> fixed_ec50_1_status = new Dictionary<string, string>();
                Dictionary<string, string> fixed_ec50_2_status = new Dictionary<string, string>();
                Dictionary<string, string> fixed_slope1_status = new Dictionary<string, string>();
                Dictionary<string, string> fixed_slope2_status = new Dictionary<string, string>();
                ...
                foreach (DataGridViewRow row in f3.dataGridView1.Rows)
                {
                    ...
                    if (cpd_string == BATCH_ID)
                    {
                        ...
                        foreach (string item in fixed_plateau1_descriptor)
                        {
                            string name = item.ToString();
                            string descriptor_name = name.Remove(0, 10);
                            fixed_plateau1_status[descriptor_name] = row.Cells["Fixed_Plateau1_" + descriptor_name].Value.ToString();
                        }

                        foreach (string item in fixed_plateau2_descriptor)
                        {
                            string name = item.ToString();
                            string descriptor_name = name.Remove(0, 10);
                            fixed_plateau2_status[descriptor_name] = row.Cells["Fixed_Plateau2_" + descriptor_name].Value.ToString();
                        }

                        foreach (string item in fixed_dip_descriptor)
                        {
                            string name = item.ToString();
                            string descriptor_name = name.Remove(0, 10);
                            fixed_dip_status[descriptor_name] = row.Cells["Fixed_Dip_" + descriptor_name].Value.ToString();
                        }

                        foreach (string item in fixed_ec50_1_descriptor)
                        {
                            string name = item.ToString();
                            string descriptor_name = name.Remove(0, 10);
                            fixed_ec50_1_status[descriptor_name] = row.Cells["Fixed_Ec50_1_" + descriptor_name].Value.ToString();
                        }

                        foreach (string item in fixed_ec50_2_descriptor)
                        {
                            string name = item.ToString();
                            string descriptor_name = name.Remove(0, 10);
                            fixed_ec50_2_status[descriptor_name] = row.Cells["Fixed_Ec50_2_" + descriptor_name].Value.ToString();
                        }

                        foreach (string item in fixed_slope1_descriptor)
                        {
                            string name = item.ToString();
                            string descriptor_name = name.Remove(0, 10);
                            fixed_slope1_status[descriptor_name] = row.Cells["Fixed_Slope1_" + descriptor_name].Value.ToString();
                        }

                        foreach (string item in fixed_slope2_descriptor)
                        {
                            string name = item.ToString();
                            string descriptor_name = name.Remove(0, 10);
                            fixed_slope2_status[descriptor_name] = row.Cells["Fixed_Slope2_" + descriptor_name].Value.ToString();
                        }
                ...
                foreach (KeyValuePair<string, List<double>> item in data_descriptor)
                {
                    ...
                    string fixed_plateau1;
                    if (fixed_plateau1_status.ContainsKey(descriptor_name)) fixed_plateau1 = fixed_plateau1_status[descriptor_name];
                    else fixed_plateau1 = "Not Fixed";

                    string fixed_plateau2;
                    if (fixed_plateau2_status.ContainsKey(descriptor_name)) fixed_plateau2 = fixed_plateau2_status[descriptor_name];
                    else fixed_plateau2 = "Not Fixed";

                    string fixed_dip;
                    if (fixed_dip_status.ContainsKey(descriptor_name)) fixed_dip = fixed_dip_status[descriptor_name];
                    else fixed_dip = "Not Fixed";

                    string fixed_ec50_1;
                    if (fixed_ec50_1_status.ContainsKey(descriptor_name)) fixed_ec50_1 = fixed_ec50_1_status[descriptor_name];
                    else fixed_ec50_1 = "Not Fixed";

                    string fixed_ec50_2;
                    if (fixed_ec50_2_status.ContainsKey(descriptor_name)) fixed_ec50_2 = fixed_ec50_2_status[descriptor_name];
                    else fixed_ec50_2 = "Not Fixed";

                    string fixed_slope1;
                    if (fixed_slope1_status.ContainsKey(descriptor_name)) fixed_slope1 = fixed_slope1_status[descriptor_name];
                    else fixed_slope1 = "Not Fixed";

                    string fixed_slope2;
                    if (fixed_slope2_status.ContainsKey(descriptor_name)) fixed_slope2 = fixed_slope2_status[descriptor_name];
                    else fixed_slope2 = "Not Fixed";
                    ...
                    Chart_DRC chart_drc = new Chart_DRC(BATCH_ID, descriptor_name, 250, ref concentrations, ref concentrations_log, ref data, color,
                        descriptor_index, deselected, chart_ec_50_status, bounds, fixed_plateau1, fixed_plateau2, fixed_dip, fixed_ec50_1, fixed_ec50_2,
                        fixed_slope1, fixed_slope2, is_data_modified, this, is_patient, true, true, true);
                    ...
                    row_params.Add(double.Parse(Math.Pow(10, parameters[3]).ToString("E2")));
                    row_params.Add(double.Parse(Math.Pow(10, parameters[4]).ToString("E2")));
                    ...
                    row_params.Add(double.Parse(parameters[2].ToString("E2")));
                    row_params.Add(double.Parse(parameters[5].ToString("E2")));
                    row_params.Add(double.Parse(parameters[6].ToString("E2")));
            ...
            if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                for (var idx = 0; idx < list_cpd.Count; idx++)
                {
                    ...
                    foreach (Chart_DRC current_chart in list_chart)
                    {
                        ...
                        removed_raw_data_cpd = current_chart.get_Removed_Raw_Data().ToList();
                        bool is_plateau1_fixed = current_chart.plateau1_fixed();
                        bool is_plateau2_fixed = current_chart.plateau2_fixed();
                        bool is_dip_fixed = current_chart.dip_fixed();
                        bool is_ec50_1_fixed = current_chart.ec50_1_fixed();
                        bool is_ec50_2_fixed = current_chart.ec50_2_fixed();
                        bool is_slope1_fixed = current_chart.slope1_fixed();
                        bool is_slope2_fixed = current_chart.slope2_fixed();
                        ...
                        {
                            DataGridViewTextBoxCell newCell = new DataGridViewTextBoxCell();
                            if (is_plateau1_fixed) newCell.Value = current_chart.get_plateau1_fixed();
                            if (is_plateau2_fixed) newCell.Value = current_chart.get_plateau2_fixed();
                            if (is_dip_fixed) newCell.Value = current_chart.get_dip_fixed();
                            if (is_ec50_1_fixed) newCell.Value = current_chart.get_ec50_1_fixed();
                            if (is_ec50_2_fixed) newCell.Value = current_chart.get_ec50_2_fixed();
                            if (is_slope1_fixed) newCell.Value = current_chart.get_slope1_fixed();
                            if (is_slope2_fixed) newCell.Value = current_chart.get_slope2_fixed();
        ...
        public void draw_images(string BATCH_ID, int BATCH_IDx, int cpd_nb)
        {
            ...
            for (int i = 0; i < wells.Count(); i++)
            {
                ...
                if (color_format == "Rgb")
                    my_bitmap = (mat.ToImage<Emgu.CV.Structure.Rgb, Byte>()).ToJpegData(); // .ToBitmap();

                if (color_format == "Bgr" || color_format == "EMT" || color_format == "SMARCA2")
                    my_bitmap = (mat.ToImage<Emgu.CV.Structure.Bgr, Byte>()).ToJpegData(); // .ToBitmap();
                ...
                if (view_images_per_concentration == true)
                {
                    ...
                    f12.dataGridView1.Rows[rows * BATCH_IDx + (counter - 1) % total_plate_nb].Cells[(counter - 1) / total_plate_nb + 1].Value = my_bitmap;
                ...
                else
                {
                    ...
                    f12.dataGridView1.Rows[index].Cells[1].Value = my_bitmap;
        ...
        private void btn_descriptors_options_Click(object sender, EventArgs e)
        {
            ...
            if (fc == null)
            {
                ...
                label_bnd_min_plateau1.Text = "Bounds Plateau1";
                ...
                label_bnd_min_plateau2.Text = "Bounds Plateau2";
                ...
                label_bnd_min_dip.Text = "Bounds Dip";
                ...
                label_bnd_min_ec50_1.Text = "Bounds EC50_1";
                ...
                label_bnd_min_ec50_2.Text = "Bounds EC50_2";
                ...
                label_bnd_min_slope1.Text = "Bounds Slope1";
                ...
                label_bnd_min_slope2.Text = "Bounds Slope2";
                ...
                foreach (Chart_DRC current_chart in list_chart)
                {
                    ...
                    new_label.Location = new Point(10, 20 + (counter + 1) * 50);
                    ...
                    text_box_bnd_min_plateau1.Location = new Point(125, 0 + (counter + 1) * 50);
                    text_box_bnd_min_plateau1.Name = "txt_box_bnd_min_plateau1_descriptor_" + descritpor_name;
                    text_box_bnd_min_plateau1.Text = dict_descriptor_min_bnd_plateau1[descritpor_name].Min().ToString();
                    ...
                    text_box_bnd_max_plateau1.Location = new Point(125, 20 + (counter + 1) * 50);
                    text_box_bnd_max_plateau1.Name = "txt_box_bnd_max_plateau1_descriptor_" + descritpor_name;
                    text_box_bnd_max_plateau1.Text = dict_descriptor_max_bnd_plateau1[descritpor_name].Max().ToString();
                    ...
                    text_box_bnd_min_plateau2.Location = new Point(250, 0 + (counter + 1) * 50);
                    ...
                    text_box_bnd_max_plateau2.Location = new Point(250, 20 + (counter + 1) * 50);
                    ...
                    text_box_bnd_min_dip.Location = new Point(375, 0 + (counter + 1) * 50);
                    ...
                    text_box_bnd_max_dip.Location = new Point(375, 20 + (counter + 1) * 50);
                    ...
                    text_box_bnd_min_ec50_1.Location = new Point(500, 0 + (counter + 1) * 50);
                    text_box_bnd_min_ec50_1.Name = "txt_box_bnd_min_ec50_1_descriptor_" + descritpor_name;
                    text_box_bnd_min_ec50_1.Text = Math.Pow(10, dict_descriptor_min_bnd_ec50_1[descritpor_name].Min()).ToString();

                    //descriptors_general_options_form.Controls.Add(text_box_bnd_min_y);
                    descriptors_general_options_form.panel1.Controls.Add(text_box_bnd_min_ec50_1);

                    TextBox text_box_bnd_max_ec50_1 = new TextBox();
                    text_box_bnd_max_ec50_1.Location = new Point(500, 20 + (counter + 1) * 50);
                    text_box_bnd_max_ec50_1.Name = "txt_box_bnd_max_ec50_1_descriptor_" + descritpor_name;
                    text_box_bnd_max_ec50_1.Text = Math.Pow(10, dict_descriptor_max_bnd_ec50_1[descritpor_name].Max()).ToString();
                    ...
                    text_box_bnd_max_slope1.Location = new Point(750, 20 + (counter + 1) * 50);
                    ...
                    text_box_bnd_min_slope2.Location = new Point(875, 0 + (counter + 1) * 50);
                    ...
                    text_box_bnd_max_slope2.Location = new Point(875, 20 + (counter + 1) * 50);
            ...
            foreach (KeyValuePair<string, List<Chart_DRC>> elem in descriptors_chart)
            {
                ...
                foreach (Chart_DRC current_chart in cpd_charts)
                {
                    if (current_chart.get_Descriptor_Name() == descriptor_name)
                    {
                        ...
                        if (if_bounds_min[3]) current_chart.set_min_bound_ec50_1(bounds_min[3]);
                        if (if_bounds_max[3]) current_chart.set_max_bound_ec50_1(bounds_max[3]);
                        if (if_bounds_min[4]) current_chart.set_min_bound_ec50_2(bounds_min[4]);
                        if (if_bounds_max[4]) current_chart.set_max_bound_ec50_2(bounds_max[4]);
        ...
        private void btn_clicked_fix_top(object sender, EventArgs e)
        {
            ...
            foreach (string descriptor_name in descriptor_list)
            {
                ...
                {
                    double fixed_plateau1 = 0.0;
                    double fixed_plateau2 = 0.0;
                    double fixed_dip = 0.0;
                    double fixed_ec50_1 = 0.0;
                    double fixed_ec50_2 = 0.0;
                    double fixed_slope1 = 0.0;
                    double fixed_slope2 = 0.0;

                    if (descriptors_fix_top_form.Controls.ContainsKey("txt_box_fix_plateau1_descriptor_" + descriptor_name))
                    {
                        TextBox txt_box_plateau1 = descriptors_fix_top_form.Controls["txt_box_fix_plateau1_descriptor_" + descriptor_name] as TextBox;
                        TextBox txt_box_plateau2 = descriptors_fix_top_form.Controls["txt_box_fix_plateau2_descriptor_" + descriptor_name] as TextBox;
                        TextBox txt_box_dip = descriptors_fix_top_form.Controls["txt_box_fix_dip_descriptor_" + descriptor_name] as TextBox;
                        TextBox txt_box_ec50_1 = descriptors_fix_top_form.Controls["txt_box_fix_ec50_1_descriptor_" + descriptor_name] as TextBox;
                        TextBox txt_box_ec50_2 = descriptors_fix_top_form.Controls["txt_box_fix_ec50_2_descriptor_" + descriptor_name] as TextBox;
        ...
        private void select_DMSO()
        {
            ...
            foreach (KeyValuePair<string, Dictionary<string, List<double>>> elem in DMSO_by_plate)
            {
                ...
                {
                    string chart_ec_50_status = "=";
                    string fixed_plateau_1 = "Not Fixed";
                    string fixed_plateau_2 = "Not Fixed";
                    string fixed_dip = "Not Fixed";
                    string fixed_ec50_1 = "Not Fixed";
                    string fixed_ec50_2 = "Not Fixed";
                    string fixed_slope1 = "Not Fixed";
                    string fixed_slope2 = "Not Fixed";
                    ...
                    Chart_DRC chart_DMSO_per_plate = new Chart_DRC(plate + " DMSO", item, 50, ref ps_concentrations_bis, ref ps_concentrations_log,
                        ref dmso_value_per_descriptor, Color.Blue, descriptor_index, deselected, chart_ec_50_status, bounds, fixed_plateau_1, 
                        fixed_plateau_2, fixed_dip, fixed_ec50_1, fixed_ec50_2, fixed_slope1, fixed_slope2, "FALSE", this,
    ...
    public class Chart_DRC
    {
        ...
        private double fixed_ec50_1 = 0.0;
        private double fixed_ec50_2 = 0.0;
        private double fixed_slope1 = 0.0;
        private double fixed_slope2 = 0.0;
        ...
        private bool is_plateau1_fixed = false;
        private bool is_plateau2_fixed = false;
        private bool is_dip_fixed = false;
        private bool is_ec50_1_fixed = false;
        private bool is_ec50_2_fixed = false;
        private bool is_slope1_fixed = false;
        private bool is_slope2_fixed = false;
        ...
        public bool plateau1_fixed()
        {
            return is_plateau1_fixed;
        }

        public bool plateau2_fixed()
        {
            return is_plateau2_fixed;
        }

        public bool dip_fixed()
        {
            return is_dip_fixed;
        }

        public bool ec50_1_fixed()
        {
            return is_ec50_1_fixed;
        }

        public bool ec50_2_fixed()
        {
            return is_ec50_2_fixed;
        }

        public bool slope1_fixed()
        {
            return is_slope1_fixed;
        }

        public bool slope2_fixed()
        {
            return is_slope2_fixed;
        }

        public double get_plateau1_fixed()
        {
            return fixed_plateau1;
        }

        public double get_plateau2_fixed()
        {
            return fixed_plateau2;
        }

        public double get_dip_fixed()
        {
            return fixed_dip;
        }

        public double get_ec50_1_fixed()
        {
            return fixed_ec50_1;
        }

        public double get_ec50_2_fixed()
        {
            return fixed_ec50_2;
        }

        public double get_slope1_fixed()
        {
            return fixed_slope1;
        }

        public double get_slope2_fixed()
        {
            return fixed_slope2;
        }
        ...
        public void set_plateau2_fixed_value(double val)
        {
            fixed_plateau2 = val;
        }

        public void set_dip_fixed_value(double val)
        {
            fixed_dip = val;
        }

        public void set_ec50_1_fixed_value(double val)
        {
            fixed_ec50_1 = val;
        }

        public void set_ec50_2_fixed_value(double val)
        {
            fixed_ec50_2 = val;
        }

        public void set_slope1_fixed_value(double val)
        {
            fixed_slope1 = val;
        }

        public void set_slope2_fixed_value(double val)
        {
            fixed_slope2 = val;
        }
        ...
        {
            if (Convert.ToInt32(general_params) + Convert.ToInt32(is_plateau1_fixed) + Convert.ToInt32(is_plateau2_fixed) + Convert.ToInt32(is_dip_fixed) + Convert.ToInt32(is_ec50_1_fixed) + Convert.ToInt32(is_ec50_2_fixed) + Convert.ToInt32(is_slope1_fixed) + Convert.ToInt32(is_slope2_fixed) + Convert.ToInt32(manual_bounds) > 0) return true;
            else return false;
        }
        ...
        public Chart_DRC(string cpd, string descript, int step, ref List<double> x, ref List<double> x_log, ref List<double> resp, Color color,
            int index, List<string> deselected, string ec_50_status, Dictionary<string, double> bounds, string fix_plateau1, string fix_plateau2,
            string fix_dip, string fix_ec50_1, string fix_ec50_2, string fix_slope1, string fix_slope2, string if_modified, MainTab form,
            bool if_patient, bool if_fit, bool if_post_paint, bool confidence)
        {
            ...
            double fixed_plateau1_val;
            if (fix_plateau1 != "Not Fixed")
            {
                bool is_converted = double.TryParse(fix_plateau1, out fixed_plateau1_val);

                fixed_plateau1 = fixed_plateau1_val;
            ...
            if (fix_plateau2 != "Not Fixed")
            {
                bool is_converted = double.TryParse(fix_plateau2, out fixed_plateau2_val);

                fixed_plateau2 = fixed_plateau2_val;
            ...
            if (fix_dip != "Not Fixed")
            {
                bool is_converted = double.TryParse(fix_dip, out fixed_dip_val);

                fixed_dip = fixed_dip_val;
            ...
            if (fix_ec50_1 != "Not Fixed")
            {
                bool is_converted = double.TryParse(fix_ec50_1, out fixed_ec50_1_val);

                fixed_ec50_1 = fixed_ec50_1_val;
            ...
            if (fix_ec50_2 != "Not Fixed")
            {
                bool is_converted = double.TryParse(fix_ec50_2, out fixed_ec50_2_val);

                fixed_ec50_2 = fixed_ec50_2_val;
            ...
            if (fix_slope1 != "Not Fixed")
            {
                bool is_converted = double.TryParse(fix_slope1, out fixed_slope1_val);

                fixed_slope1 = fixed_slope1_val;
            ...
            if (fix_slope2 != "Not Fixed")
            {
                bool is_converted = double.TryParse(fix_slope2, out fixed_slope2_val);

                fixed_slope2 = fixed_slope2_val;
        ...
        private double BellShaped(double[] c, double x)
        {
            // plateau1 = c[0]
            // plateau2 = c[1]
            // Dip = c[2]
        ...
        public void fit_DRC()
        {
            ...
            double epsf = 0;
            double epsx = 1e-12; //1e-12; // 0.000000001;
            double diffstep = 1e-15; //1e-15;
            ...
            alglib.lsfitfit(state, function_BellShaped, null, null);
            alglib.lsfitresults(state, out info, out c, out rep);
            ...
            */
            ...
            for (int IdxConc = 0; IdxConc < x_fit.Count; IdxConc++)
            {
                y_fit_log.Add(BellShaped(c, x_fit_log[IdxConc]));
            }
        }
        ...
        public void test_two_points_around_top(double thr_2_last_points)
        {
            ...
            if (dict_points.Count() > 2)
            {
                ...
                if (diff_top_last_point <= thr_2_last_points * Math.Abs(top - bottom) && diff_top_last_point2 <= thr_2_last_points * Math.Abs(top - bottom))
                {
                    ...
                    annotation_ec50.Text = "EC_50 = " + Math.Pow(10, fit_parameters[3]).ToString("E2") + " | R2 = " + r2.ToString("N2");
        ...
        public void draw_DRC(bool if_report, bool add_chart)
        {
            ...
            _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Value = double.Parse(Math.Pow(10, fit_parameters[3]).ToString("E2"));
            _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Value = double.Parse(Math.Pow(10, fit_parameters[4]).ToString("E2"));

            if (fit_parameters[0] < fit_parameters[1])
            {
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Value = double.Parse(fit_parameters[0].ToString("E2"));
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Value = double.Parse(fit_parameters[1].ToString("E2"));
            }
            else
            {
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Value = double.Parse(fit_parameters[1].ToString("E2"));
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Value = double.Parse(fit_parameters[0].ToString("E2"));
            }
            _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 5].Value = double.Parse(fit_parameters[2].ToString("E2"));
            _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 6].Value = double.Parse(fit_parameters[5].ToString("E2"));
            _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 7].Value = double.Parse(fit_parameters[6].ToString("E2"));
            _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 8].Value = double.Parse(r2.ToString("E2"));


            if (drc_points_x_disable.Count() > 0)
            {
                data_modified = true;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 5].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 6].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 7].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 8].Style.BackColor = Color.LightSeaGreen;
            }
            else
            {
                if ((is_plateau2_fixed || manual_bounds) && data_modified)
                {
                    data_modified = true;
                ...
                else
                {
                    ...
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Style.BackColor = Color.White;
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Style.BackColor = Color.White;
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Style.BackColor = Color.White;
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Style.BackColor = Color.White;
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 5].Style.BackColor = Color.White;
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 6].Style.BackColor = Color.White;
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 7].Style.BackColor = Color.White;
                    _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 8].Style.BackColor = Color.White;
                }
            }
            ...
            if (not_fitted)
            {
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Value = "Not Fitted";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Value = "Not Fitted";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Value = "Not Fitted";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Value = "Not Fitted";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 5].Value = "Not Fitted";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 6].Value = "Not Fitted";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 7].Value = "Not Fitted";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 8].Value = "Not Fitted";

                data_modified = true;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Style.BackColor = Color.Tomato;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Style.BackColor = Color.Tomato;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Style.BackColor = Color.Tomato;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Style.BackColor = Color.Tomato;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 5].Style.BackColor = Color.Tomato;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 6].Style.BackColor = Color.Tomato;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 7].Style.BackColor = Color.Tomato;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 8].Style.BackColor = Color.Tomato;
            ...
            if (inactive)
            {
                ...
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Value = "Inactive";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Value = "Inactive";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Value = "Inactive";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Value = "Inactive";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 5].Value = "Inactive";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 6].Value = "Inactive";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 7].Value = "Inactive";
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 8].Value = "Inactive";

                data_modified = true;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Style.BackColor = Color.Orange;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Style.BackColor = Color.Orange;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Style.BackColor = Color.Orange;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 4].Style.BackColor = Color.Orange;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 5].Style.BackColor = Color.Orange;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 6].Style.BackColor = Color.Orange;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 7].Style.BackColor = Color.Orange;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 8].Style.BackColor = Color.Orange;

                annotation_ec50.Text = "EC_50 = Inactive";
            }

            if ((is_plateau2_fixed || manual_bounds) && data_modified == true && inactive == false && not_fitted == false) // general_params || 
            {
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 1].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 2].Style.BackColor = Color.LightSeaGreen;
                _form1.f2.dataGridView2.Rows[row_index].Cells[8 * descriptor_index + 3].Style.BackColor = Color.LightSeaGreen;
        ...
        private void chart1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left && pointer_y > 18)
            {
                ...
                {
                    if (is_plateau2_fixed || manual_bounds)
                    {
                        data_modified = true;
